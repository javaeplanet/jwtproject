package com.javaeplanet.flightcheckin.controllers;
...
import com.javaeplanet.flightcheckin.integration.ReservationRestClient;
...
public class CheckInController {
	...
	public String completeCheckIn(@RequestParam("reservationId")  Long reservationId, @RequestParam("numberOfBags")   int numberOfBags) {
		...
		restClient.updateReservation(reservationUpdateRequest, reservationId);
